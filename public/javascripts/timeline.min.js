...
function timeline(e, d) {
    ...
    function m(e) {
        ...
        else $('.timeline-nav-button--next').attr('disabled','true')
    }

    function n(e) {
        var t, n, l, i, o, r, s, a;
        e.timelineEl.classList.add("timeline--horizontal"), t = e, window.innerWidth > t.forceVerticalMode && (t.itemWidth = t.wrap.offsetWidth / t.visibleItems, t.items.forEach(function(e) {
            e.style.width = t.itemWidth + "px"
        }), t.scrollerWidth = t.itemWidth * t.items.length, t.scroller.style.width = t.scrollerWidth + "px", l = n = 0, t.items.forEach(function(e, t) {
            e.style.height = "auto";
        ...
        }), t.scroller.style.height = l + n + "px"), m(e),
            function(e) {
            ...
            }(e), o = (i = e).timelineEl.querySelectorAll(".timeline-nav-button"), r = i.timelineEl.querySelector(".timeline-nav-button--prev"), s = i.timelineEl.querySelector(".timeline-nav-button--next"), a = i.items.length - i.visibleItems, [].forEach.call(o, function(e) {
            e.addEventListener("click", function(e) {
                e.preventDefault(), 0 === (c = this.classList.contains("timeline-nav-button--next") ? c += 8 : c -= 8) ? (r.disabled = !0, s.disabled = !1) : c === a ? (r.disabled = !1, s.disabled = !0) : (r.disabled = !1, s.disabled = !1), m(i)
            })
        })
    }
    ...
    function o() {
        f.forEach(function(e) {
            e.timelineEl.style.opacity = 0, e.timelineEl.classList.contains("timeline--loaded") || e.items.forEach(function(e) {
                ...
                function(e) {
                    c = 0, e.timelineEl.classList.remove("timeline--horizontal", "timeline--mobile"), e.scroller.removeAttribute("style"), e.items.forEach(function(e) {
                ...
                i.items.forEach(function(e, t) {
                    e.classList.remove("animated", "fadeIn"), !l(e) && 0 < t ? e.classList.add("animated") : n = t, t % 2 == ("left" === i.verticalStartPosition ? 1 : 0) && window.innerWidth > v.forceVerticalMode ? e.classList.add("timeline__item--right") : e.classList.add("timeline__item--left")
                });
